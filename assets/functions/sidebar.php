...
function joints_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'storemenu',
		'name' => __('Store Menu', 'jointswp'),
		'description' => __('Menu for the Gear Store', 'jointswp'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
	...
	register_sidebar(array(
		'id' => 'storemenu-sm',
		'name' => __('Store Menu SM', 'jointswp'),
		'description' => __('Small Menu for the Gear Store', 'jointswp'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
